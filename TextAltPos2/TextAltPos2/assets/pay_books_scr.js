...
function onclick_credit_grabinfo()
{
   ...
   if ( !fault )
   {
	  ...
	  document.getElementById("custname").value = track_data.account_name;	  
	  document.getElementById("last4").value = track_data.account.substring(12,16);
	  document.getElementById("ccnumber").value = track_data.account;
	  document.getElementById("expdate").value = track_data.exp_month + track_data.exp_year.substring(2,4);
