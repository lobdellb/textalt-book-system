    ...
    public partial class CheckIn : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (tbBarcode.Text.Trim().Length > 0)
            {
                ...
                {
                    BD.ChangeInventory(BarCode, 0, BookCount, rbRegion.Text);
                    lblJustAdded.Text = "added " + BookCount.ToString() + " used " + BarCode + " to " + rbRegion.Text;
                ...
                {
                    BD.ChangeInventory(BarCode, BookCount, 0, rbRegion.Text);
                    lblJustAdded.Text = "added " + BookCount + " new " + BarCode + " to " + rbRegion.Text;
