<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ReturnBooks.aspx.cs" Inherits="TextAltPos.ReturnBooks" Title="Return Stuff" %>
...
&nbsp;<asp:TextBox ID="tbSaleNum" runat="server" ontextchanged="tbSaleNum_TextChanged"></asp:TextBox>
    ...
    <asp:Button ID="btnFind" runat="server" Text="Find" onclick="btnFind_Click" />
        ...
        <asp:CheckBox ID="cbOverrideReturnDate" runat="server" 
            Text="Override Return Date" Visible="False" />
    ...
    <asp:Panel ID="pnlSold" runat="server" Width="100%" Visible="False">
        ...
        Tax:  <asp:Label ID="lblTax" runat="server" Text="Label"></asp:Label>
        <br />
        <br />
        <span style="font-size: x-large; font-weight: bold; color: #FF0000; background-color: #FFFFFF">
        Check receipt dates to verify elligibility for this return.</span><br />
        <br />
        Books on this purchase
        <asp:GridView ID="gvBoughtBooks" runat="server" BackColor="White" 
            BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
            GridLines="Vertical" AutoGenerateColumns="False" 
            onrowdatabound="gvBoughtBooks_RowDataBound" DataKeyNames="id">
        ...
        <br />
        Return Percentage&nbsp;&nbsp;
        <asp:TextBox ID="tbReturnPercent" runat="server" AutoPostBack="True" 
            ontextchanged="tbReturnPercent_TextChanged" Width="61px">100</asp:TextBox>
        %<br />
