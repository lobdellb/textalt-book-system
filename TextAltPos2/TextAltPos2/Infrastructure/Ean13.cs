...
namespace Ean13Barcode2005
{
	public class Ean13
	{
        ...
        private float _fWidth = 2260f;
        private float _fHeight = 1500f;
		private float _fFontSize = 48.0f;
		...
		{
			float tempWidth = ( this.Width * this.Scale );
			float tempHeight = ( this.Height * this.Scale );
