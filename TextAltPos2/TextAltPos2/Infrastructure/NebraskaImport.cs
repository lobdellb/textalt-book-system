...
namespace TextAltPos
{
    ...
    class NebraskaImport
    {

        public bool Main(string FileName,DateTime StartDate, DateTime EndDate)
        {
        ...
        //    string Filename = Console.ReadLine();
            ...
            string WholeSaler = "Nebraska";

            NebraskaData nebraskaData = new NebraskaData(FileName,StartDate,EndDate);
    ...
    class NebraskaData
    {
        ...
        public NebraskaData(string fn,DateTime StartDate, DateTime EndDate )
        {
        ...
        public void ReadRecord()
        {
            ...
            if (LastRdrReturn)
            {
                ...
                mTitle = NextLine.Substring(24, 70).Trim();
                mAuthor = NextLine.Substring(9, 15).Trim();
                mPublisher = NextLine.Substring(127, 11).Trim();
                mEdition = NextLine.Substring(111, 2).Trim();
                mYear = NextLine.Substring(111, 2).Trim();
                mNewPrice = NextLine.Substring(138, 5).Trim();
                mNewOffer = NextLine.Substring(138, 5).Trim();
                mUsedOffer = NextLine.Substring(138, 5).Trim();
                mISBN = NextLine.Substring(94, 13).Replace("-", string.Empty).Trim();
