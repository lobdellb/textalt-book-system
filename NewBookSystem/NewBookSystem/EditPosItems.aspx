<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditPosItems.aspx.cs" Inherits="NewBookSystem.EditPosItems" Title="Edit Custom Items" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gvItems" runat="server" AutoGenerateColumns="False" 
        ...
        CellPadding="3" DataKeyNames="pk" EmptyDataText="No item(s) found." 
